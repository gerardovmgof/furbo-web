...
export default function TerminosPage() {
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-12 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
      <h1 className="mb-6 text-2xl font-semibold text-zinc-900 dark:text-zinc-100">Términos y condiciones de uso</h1>
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">1. Naturaleza del servicio</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">2. Cuentas de acceso</h2>
      <ul className="mb-4 list-disc pl-6">
        ...
        <li>
          <strong className="text-zinc-800 dark:text-zinc-200">Debes ser mayor de edad</strong> para recibir y usar
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">3. Registro de jugadores</h2>
      <ul className="mb-4 list-disc pl-6">
        <li>
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">4. Uso aceptable</h2>
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">5. Información deportiva</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">6. Limitación de responsabilidad</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">7. Pagos con Mercado Pago</h2>
      <p className="mb-4">
        ...
        <strong className="text-zinc-800 dark:text-zinc-200">Mercado Pago</strong> para completar el pago. La
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">8. Privacidad</h2>
      <p className="mb-4">
        El tratamiento de datos personales se rige por nuestro{" "}
        <a href="/privacidad" className="text-emerald-700 dark:text-emerald-400 underline hover:text-emerald-800 dark:hover:text-emerald-300">
          Aviso de Privacidad
        </a>
        .
      </p>

      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-900 dark:text-zinc-100">9. Modificaciones</h2>
      <p className="mb-4">
