  ...
  return (
    <main className="mx-auto max-w-3xl space-y-8 py-8">
      ...
      <div className="space-y-3">
        ...
        {owners.map((u) => (
          <div key={u.id} className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 p-4">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <p className="font-semibold text-zinc-900 dark:text-zinc-100">{u.username}</p>
      ...
      <div className="space-y-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-zinc-400 dark:text-zinc-600 dark:text-zinc-400">Árbitros</h2>
        {referees.length === 0 && <p className="text-sm text-zinc-500">Aún no hay árbitros.</p>}
        {referees.map((r) => (
          <div key={r.id} className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 p-4">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <p className="font-semibold text-zinc-900 dark:text-zinc-100">{r.username}</p>
