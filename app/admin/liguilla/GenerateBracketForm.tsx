...
export default function GenerateBracketForm({ tournamentId }: { tournamentId: string }) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-zinc-300">Equipos que clasifican</label>
      ...
      <label className="flex items-center gap-2 text-sm text-zinc-200">
        <input type="checkbox" name="twoLegs" className="h-4 w-4 rounded border-zinc-700 bg-zinc-950" />
