...
export default function PrivacidadPage() {
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-12 text-sm leading-relaxed text-zinc-300">
      <h1 className="mb-6 text-2xl font-semibold text-zinc-100">Aviso de privacidad</h1>
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-100">1. Responsable del tratamiento</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-100">2. Datos personales que recabamos</h2>
      <p className="mb-2">La Plataforma recaba únicamente los datos mínimos necesarios:</p>
      <ul className="mb-4 list-disc pl-6">
        <li>
          <strong className="text-zinc-200">Delegados de equipo:</strong> nombre de usuario asignado
          por la administración de la liga.
        </li>
        <li>
          <strong className="text-zinc-200">Jugadores:</strong> nombre y número de camiseta
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-100">4. Menores de edad</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-100">5. Transferencias</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-100">7. Cookies</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 mt-8 text-lg font-semibold text-zinc-100">8. Cambios a este aviso</h2>
      <p className="mb-4">
